...
from voltatrees.volta_XGBM.compiler.ast.nodes import DecisionNode, Forest, LeafNode, Tree
from voltatrees.volta_XGBM.compiler.ast.scanner import scan_model_file
from voltatrees.volta_XGBM.compiler.utils import DecisionType
...
def parse_to_ast(model_path, features):
    scanned_model = scan_model_file(model_path, features)
